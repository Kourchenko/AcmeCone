...
public class LoginActivity extends ActionBarActivity implements NavigationDrawerCallbacks {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mToolbar = (Toolbar) findViewById(R.id.login_toolbar_actionbar);
        setSupportActionBar(mToolbar);

        mNavigationDrawerFragment = (NavigationDrawerFragment)
                getFragmentManager().findFragmentById(R.id.login_fragment_drawer);

        // Set up the drawer.
        mNavigationDrawerFragment.setup(R.id.login_fragment_drawer, (DrawerLayout) findViewById(R.id.login_drawer), mToolbar);
