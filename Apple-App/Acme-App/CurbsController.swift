...
class CurbsController: UIViewController, UITextFieldDelegate, UIPickerViewDelegate, UIPickerViewDataSource {
            ...
            if (!_optional.isEmpty) {
                if ((Int(quantity) == nil)
                    ...
                    if (results.isEmpty) {
                        ...
                        let alert: UIAlertView = UIAlertView(title: "", message: "These Curb Measurements exist in your Cart!", delegate: nil, cancelButtonTitle: "OK");
